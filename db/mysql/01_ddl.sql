-- ANS Intelligence - Schema
-- Executado automaticamente na inicialização do container MySQL
CREATE DATABASE IF NOT EXISTS ans_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE ans_db;
CREATE TABLE IF NOT EXISTS cadop_operadoras_ativas (
    ...
    INDEX idx_cadop_registro (registro_ans),
    INDEX idx_cadop_razao_social (razao_social(64))
);
